            ...
            <div class="mcontainer">
                <div class="row-body">
                    <div class="checkout-form">
                        ...
                        <input class="input" placeholder="Full name" type="text" id="fullname" required="required" />
                        <input class="input" placeholder="Email" type="text" id="email" required="required" />
                        <input class="input" placeholder="Subject" type="text" id="subject" required="required" />
                        <label for="cardName">Your Message.</label>
                        <textarea class="input" placeholder="Message" id="message" required="required" style="height: 40%; resize: none;"></textarea>
                        <a class="btn btn-primary" href="Contact.aspx">Send Message</a>
                    </div>
                </div>
            </div>
        </form>
