<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductDetail.aspx.cs" Inherits="WebApplication1.aspx.ProductDetail" %>
...
<head>
    ...
    <title>Chi Tiết Sản Phẩm - group5Gym</title>
...
<body>
    ...
    %>
                    ...
                    <span id="cartCountLabel" runat="server" class="cart-count">0</span>
                </div>
            </div>
        </header>
        <main>
            ...
            <div class="container">
                <div class="product-details">
                    ...
                    <div class="product-info">
                        ...
                        <p class="price" id="productPrice" runat="server"></p>

                        <div class="quantity">
                            <label for="quantity">Quantity:</label>
                            <input type="number" id="quantity" runat="server" name="quantity" min="1" value="1">
                        </div>
            ...
            <div class="container other-product">
                ...
                <div class="product-grid" id="otherProductsContainer" runat="server">
                    <!-- Các sản phẩm khác sẽ được hiển thị tại đây -->
                </div>
            </div>
        </main>
        <footer>
