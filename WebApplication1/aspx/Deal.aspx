<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deal.aspx.cs" Inherits="WebApplication1.aspx.Deal" %>
...
<body>
    ...
    <main class="deal-results">
        <div class="container" id="DealContainer" runat="server">
            <h1>Current Deals</h1>
            <div class="row">
